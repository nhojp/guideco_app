...
<body>
    <div class="container">
        ...
        <table class="table-form">
            <tr>
                <td>
                <p style="margin-left: 50px;"> Designation/Position: <u><?php echo htmlspecialchars($complaint['complainedDesignation']); ?></u>
                </td>
            </tr>
        </table>
        ...
        <table class="table-form">
            <tr>
                <td>
                <p style="margin-left: 50px;"> Address: <u><?php echo htmlspecialchars($complaint['complainedAddress']); ?></u>
                </td>
            </tr>
        </table>
