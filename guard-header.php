...
if (isset($_SESSION['loggedin'])) {
    ...
    if ($guard_id) {
        ...
        $sql = "SELECT * FROM guards WHERE id = $guard_id";
        ...
        if ($result && $result->num_rows == 1) {
            ...
            $first_name = "Guard"; // Example default value
            $last_name = "";
        ...
        echo "Guard ID not set in session.";
    }
} else {
...
<div class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header">
    <div class="app-header header-shadow">
        <div class="app-header__logo">
            <a class="logo-srcs text-dark" href="guard-index.php"
                        ...
                        <div class="widget-content-wrapper">
                            ...
                            <div class="widget-content-left">
                                ...
                                <div tabindex="-1" role="menu" aria-hidden="true"
                                    ...
                                    <a class="dropdown-item" href="guard-credentials.php">
